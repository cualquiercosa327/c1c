...
ZZ_35438_D8:
	...
	{
		S3 |= S2;
		ZZ_CLOCKCYCLES(73,0x80035638);
		goto ZZ_35438_200;
	}
	S3 |= S2;
	S3 |= A0;
	ZZ_CLOCKCYCLES(74,0x80035638);
ZZ_35438_200:
...
ZZ_35438_254:
	...
	{
		T6 = A1 + V1;
		ZZ_CLOCKCYCLES(59,0x80035780);
		goto ZZ_35438_348;
	}
	T6 = A1 + V1;
	V1 = R0;
	T6 = A1 + V1;
	ZZ_CLOCKCYCLES(61,0x80035780);
ZZ_35438_348:
	SP = EMU_ReadU32(T6);
	FP = T3 & GP;
	EMU_Write32(T6,FP);
...
ZZ_35438_36C:
	...
	{
		T6 = A1 + V1;
		ZZ_CLOCKCYCLES(23,0x80035808);
		goto ZZ_35438_3D0;
	}
	T6 = A1 + V1;
	V1 = R0;
	T6 = A1 + V1;
	ZZ_CLOCKCYCLES(25,0x80035808);
ZZ_35438_3D0:
	SP = EMU_ReadU32(T6);
	FP = T3 & GP;
	EMU_Write32(T6,FP);
	...
	EMU_Write32(T3,SP);
	T3 += 28;
	ZZ_CLOCKCYCLES(7,0x80035824);
ZZ_35438_3EC:
	T5 -= 1;
	if (T5)
	{
		AT = EMU_ReadU16(T2);
		ZZ_CLOCKCYCLES(3,0x800354CC);
		goto ZZ_35438_94;
	}
	AT = EMU_ReadU16(T2);
	AT = 0x1F800000;
	...
	ZZ_JUMPREGISTER(0x800195B4,ZZ_19508_AC);
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x80035438,0x800354CC,ZZ_35438);
ZZ_MARK_TARGET(0x800354CC,0x80035510,ZZ_35438_94);
ZZ_MARK_TARGET(0x80035510,0x80035638,ZZ_35438_D8);
ZZ_MARK_TARGET(0x80035638,0x8003568C,ZZ_35438_200);
ZZ_MARK_TARGET(0x8003568C,0x80035780,ZZ_35438_254);
ZZ_MARK_TARGET(0x80035780,0x800357A4,ZZ_35438_348);
ZZ_MARK_TARGET(0x800357A4,0x80035808,ZZ_35438_36C);
ZZ_MARK_TARGET(0x80035808,0x80035824,ZZ_35438_3D0);
ZZ_MARK_TARGET(0x80035824,0x80035898,ZZ_35438_3EC);
