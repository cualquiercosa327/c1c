...
ZZ_342D8_14:
	...
	{
		A0 += 256;
		ZZ_CLOCKCYCLES(130,0x800344FC);
		goto ZZ_342D8_224;
	}
	A0 += 256;
	A1 = EMU_CheckedAdd(A1,-1);
	ZZ_CLOCKCYCLES(132,0x800342EC);
	goto ZZ_342D8_14;
ZZ_342D8_224:
	ZZ_JUMPREGISTER_BEGIN(RA);
	EMU_Write32(A0 - 4,T0); //+ 0xFFFFFFFC
	ZZ_CLOCKCYCLES_JR(2);
	ZZ_JUMPREGISTER(0x80016DE8,ZZ_16DCC_1C);
	ZZ_JUMPREGISTER(0x800172C0,ZZ_16E5C_464);
	ZZ_JUMPREGISTER_END();
#endif
ZZ_MARK_TARGET(0x800342D8,0x800342EC,ZZ_342D8);
ZZ_MARK_TARGET(0x800342EC,0x800344FC,ZZ_342D8_14);
ZZ_MARK_TARGET(0x800344FC,0x80034504,ZZ_342D8_224);
