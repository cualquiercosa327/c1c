...
extern char *GOOL_DIS_Disassemble(uint32_t ins, uint32_t pc);

extern char *GOOL_DIS_FormatRef(char *str, uint32_t ref, int mode);
extern char *GOOL_DIS_FormatLnk(char *str, uint32_t lnk);
extern char *GOOL_DIS_FormatVec(char *str, uint32_t vec);
extern char *GOOL_DIS_FormatCol(char *str, uint32_t col);
